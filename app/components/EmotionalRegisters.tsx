...
const registers = [
  {
    ...
    accentLevel: "Subliminal \u2014 gold at 0.06 opacity, felt not seen",
  ...
  },
  {
    ...
    accentLevel: "Decorative \u2014 gold at 0.4 for epigraphs and ornaments",
  ...
  },
  {
    ...
    accentLevel: "Ambient \u2014 gold at 0.3 for orientation",
  ...
  },
  {
    ...
    accentLevel: "Interactive \u2014 gold at full opacity for focus states",
  ...
  },
  {
    ...
    accentLevel: "Texture \u2014 gold at 0.03, the ghost of presence",
  ...
  return (
    <section id="registers" className="showcase-section">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          Content type determines design treatment. The same passage rendered in
          five different registers &mdash; from full sacred reverence to ambient
          absence. Each register governs whitespace, typography, accent level,
          motion speed, and distraction tolerance.
        </p>
              ...
              style={{
                ...
                color:
                  selectedRegister === r.id
                    ? "var(--color-navy)"
                    : "var(--color-text)",
                border: `1px solid ${selectedRegister === r.id ? "var(--color-gold)" : "var(--color-border)"}`,
